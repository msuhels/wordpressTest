	   ...
	   if( $disable_footer_copyright == 'false') { ?>
		...
		<div class="row" id="copyright">
			...
			<div class="container" align="center">
                	<div class="col span_12 col_last foter" align="center">
					<ul id="social" style="float:none;">
            ...
            <div class="clearfix " style="clear:both;"></div>
                <div class="col span_12">
					...
					<?php if(!empty($options['disable-auto-copyright']) && $options['disable-auto-copyright'] == 1) { ?>
						<p>&copy; <?php echo date('Y'); ?> <?php if(!empty($options['footer-copyright-text'])) echo $options['footer-copyright-text']; ?> </p>	
					<?php } else { ?>
