...
echo '<div class="khan col span_12 testimonial_slider '.$height_animation_class.'" data-color="'.$color.'" data-autorotate="'.$autorotate.'" data-style="'.$style.'" ><div class="slides">'.do_shortcode($content).'</div></div>';
